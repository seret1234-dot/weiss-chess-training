...
INPUT_FOLDER = r"C:\Users\Ariel\chess-trainer\bn_manual_sets\bn positions_24-3-2026\bn2\4\6"
OUTPUT_FOLDER = r"C:\Users\Ariel\chess-trainer\bn_manual_sets\bn positions_24-3-2026\bn2\4\7"
CHUNK_SIZE = 30
...
def square_order(square: str):
    ...
    rank = int(square[1])
    return (-rank, file_idx)   # a8 -> h8, then a7 -> h7, etc.
