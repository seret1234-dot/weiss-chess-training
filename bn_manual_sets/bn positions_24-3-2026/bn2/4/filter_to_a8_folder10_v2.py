...
OUTPUT_FOLDER = r"C:\Users\Ariel\chess-trainer\bn_manual_sets\bn positions_24-3-2026\bn2\4\10"

MAX_PLIES = 24
TIME_PER_MOVE = 0.05  # seconds per move, much safer on long/no-mate cases
...
def main():
    ...
    print(f"Will scan files 001-088 only: {len(files)}")
