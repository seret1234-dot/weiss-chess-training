...
TARGET_POSITIONS = 300

BLACK_KING = chess.D8

OUTPUT_JSON = r"C:\Users\Ariel\chess-trainer\bn_manual_sets\bn positions_24-3-2026\bk_d8_typical_300.json"
...
def main():
    ...
    try:
        for wk in SQUARES:
            ...
            # wider typical W zone
            if chebyshev_distance(BLACK_KING, wk) > 4:
                continue
            ...
            for wn in SQUARES:
                ...
                for wb in SQUARES:
                    ...
                    if len(results) >= TARGET_POSITIONS:
                        print("Reached target:", TARGET_POSITIONS)
                        raise StopIteration
