...
// Small noise guard: treat very close evals as same result
function sameResult(a, b) {
  ...
  if (typeof a.eval === "number" && typeof b.eval === "number") {
    return Math.abs(a.eval - b.eval) < 0.5;
  }

  return false;
}

// Always accept engine best move (fix hint issue)
