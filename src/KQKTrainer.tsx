    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span>{currentChunk?.label ?? 'K + Q vs K'}</span>
          ...
          <div style={panelCardStyle}>
            ...
            <div><strong>Chunk target:</strong> mate in {currentChunk?.mateDistance ?? '-'}</div>
            <div><strong>Puzzle target:</strong> mate in {currentPuzzle?.mateDistance ?? '-'}</div>
            <div><strong>Live engine:</strong> {liveWhiteMateDistance === '—' ? '—' : `mate in ${liveWhiteMateDistance}`}</div>
            <div><strong>Engine best:</strong> {currentBestMoveUci ?? '-'}</div>
            <div><strong>Engine raw mate:</strong> {engineInfo?.mate ?? '-'}</div>
            <div><strong>Engine eval:</strong> {engineInfo?.eval ?? '-'}</div>
            <div><strong>WK:</strong> {wkSquare || '-'} | <strong>BK:</strong> {bkSquare || '-'}</div>
            <div><strong>WQ:</strong> {queenSquare || '-'}</div>
          </div>
