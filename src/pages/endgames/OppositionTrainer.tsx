...
function chooseHintMove(
 ...
 // First move: use the prepared stalemate concept move.
 if (atStart) {
...
if (!hintMoveUci) {
 ...
 reason:
 currentPosition?.explanation ||
 "Start with the stalemate move first.",
 afterUser: null,
 };
 }
 ...
 // After the first stalemate move, engine best move is accepted.
 ...
 ok: false,
 reason:
 "Wrong: this move lets the stalemate/conversion slip. Keep the king active, support the pawn, and avoid giving the defender stalemate.",
 afterUser: afterInfo,
 };
 }
