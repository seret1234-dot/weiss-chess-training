...
rl.on("line", (line) => {
 ...
 // Lichess format: preMove + solution move.
 // Mate in 1 needs 1 preMove + 1 solution move.
...
rl.on("close", () => {
 ...
 source: "lichess",
 localId: `arabian_mate_1_chunk_${String(chunkNumber).padStart(3, "0")}_puzzle_${indexInChunk + 1}`,
