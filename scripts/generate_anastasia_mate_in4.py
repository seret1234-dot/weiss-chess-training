...
OUT_DIR = ROOT / "public" / "data" / "lichess" / "mate_in_4" / "anastasia"

CHUNK_SIZE = 30
CATEGORY = "Mate in 4"
THEME_NAME = "Anastasia Mate"

REQUIRED_THEMES = {"anastasiaMate", "mateIn4"}
SOLUTION_LENGTH = 7
USER_MOVE_INDEXES = [0, 2, 4, 6]
...
def main():
    ...
    print(f"Found {len(puzzles)} Anastasia Mate in 4 puzzles")
