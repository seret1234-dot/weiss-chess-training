...
rl.on("line", (line) => {
 ...
 if (!themes.includes("mateIn1")) return
 ...
 // preMove + 1 solution move for mate in 1
...
rl.on("close", () => {
 ...
 source: "lichess",
 localId: `boden_mate_1_chunk_${String(chunkNumber).padStart(3, "0")}_puzzle_${indexInChunk + 1}`,
