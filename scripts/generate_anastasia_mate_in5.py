...
OUT_DIR = ROOT / "public" / "data" / "lichess" / "mate_in_5" / "anastasia"

CHUNK_SIZE = 30
CATEGORY = "Mate in 5"
THEME_NAME = "Anastasia Mate"

REQUIRED_THEMES = {"anastasiaMate", "mateIn5"}
SOLUTION_LENGTH = 9
USER_MOVE_INDEXES = [0, 2, 4, 6, 8]
...
def main():
    ...
    print(f"Found {len(puzzles)} Anastasia Mate in 5 puzzles")
