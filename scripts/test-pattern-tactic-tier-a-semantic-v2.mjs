...
try {
  ...
  assert.equal(disclosureRuntime.getSemanticDisclosureCountdownSeconds(assistedCountdown, 0), 7, "wrong answers and hints start a seven-second countdown")
...
assert.match(trainer, /scheduleSemanticAutoAdvance\('correct'\)/, "correct Tier A answers schedule a five-second auto-advance")
assert.match(trainer, /scheduleSemanticAutoAdvance\('assisted'\)/, "wrong answers and hints schedule a seven-second auto-advance")
