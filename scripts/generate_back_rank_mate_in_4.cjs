...
rl.on("line", (line) => {
 ...
 if (!themes.includes("mateIn4")) return
 ...
 // preMove + 7 solution moves for mate in 4
...
rl.on("close", () => {
 ...
 source: "lichess",
 localId: `back_rank_mate_4_chunk_${String(chunkNumber).padStart(3, "0")}_puzzle_${indexInChunk + 1}`,
