...
rl.on("line", (line) => {
 ...
 if (!themes.includes("mateIn5")) return
 ...
 // preMove + 9 solution moves for mate in 5
...
rl.on("close", () => {
 ...
 source: "lichess",
 localId: `back_rank_mate_5_chunk_${String(chunkNumber).padStart(3, "0")}_puzzle_${indexInChunk + 1}`,
